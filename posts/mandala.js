(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.app = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    var GameControls = function () {
        ...
        this.evolve = false;
        let cells;
        let colors = { red: true, green: true, blue: true };
        let display;
        let game;
        ...
        function genCells(cell_size_x, cell_size_y, canvas_width, canvas_height, frequency) {
            let width = canvas_width || getMaxWidth();
            let height = canvas_height || getMaxHeight();
            let num_cells_x = Math.floor(width / cell_size_x);
            let num_cells_y = Math.floor(height / cell_size_y);
            let cells = [];
        ...
        this.selectType = function (value) {
            this.selected = value;
        };
        this.createNewGame = function () {
            ...
            display = new GameDisplay_1.GameDisplay("life", cells.length, cells[0].length, this.cell_width, this.cell_width, this.alpha);
            switch (this.selected) {
                case 'base':
                    game = new GameOfLife_1.GameOfLifeBase(display, cells, this.cell_width, this.cell_width, colors, this.evolve);
                    break;
                case 'mandala1':
                    game = new GameOfLife_1.GameOfLifeMandala1(display, cells, this.cell_width, this.cell_width, colors, this.evolve);
                    break;
                case 'mandala2':
                    game = new GameOfLife_1.GameOfLifeMandala2(display, cells, this.cell_width, this.cell_width, colors, this.evolve);
                    break;
                default:
                    game = new GameOfLife_1.GameOfLifeBase(display, cells, this.cell_width, this.cell_width, colors, this.evolve);
            }
        ...
        this.updateAlpha = function (value) {
    ...
    window.onload = function () {
        ...
        gui.add(gameControls, 'selected', ['base', 'mandala1', 'mandala2']).onChange(function (value) { gameControls.selectType(value); });
    ...
    },{"./GameDisplay":2,"./GameOfLife":3,"dat.gui":1}]},{},[4])(4)
    });